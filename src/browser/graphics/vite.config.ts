  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        square_one_cam: resolve(__dirname, 'square_one_cam.html'),
        square_two: resolve(__dirname, 'square_two.html'),
        square_two_camera: resolve(__dirname, 'square_two_cam.html'),
        ...
        wide_one_cam: resolve(__dirname, 'wide_one_cam.html'),
        wide_two: resolve(__dirname, 'wide_two.html'),
        wide_two_cam: resolve(__dirname, 'wide_two_cam.html'),
